...
<div>
 ...
 <div class="ddd1" style="float: right;"> 
   ...
   <a href="login.php"><button style="width: 100px; " class="in" > log in</button> </a>
   <a href="signup.php"><button style="width: 130px; " class="in" > sign up</button> </a>
    <a href="galary.html"><button style="width: 100px; " class="in" > galary</button> </a>
    <input type="text" name="searchaw" style="width: 300px;height: 43px; size: 30px;border:none  ;background-color: pink;size: 30px; border-radius: 0px;" class="in" placeholder="search" required><a >
...
<form name="fo1" style="width:300px" method="post" onSubmit="return check()">  
  <div >  
    <label  style="font-size: 20px; margin-left: 500px;">Email </label>  <br>
   
    <input type="email" id="em" name="email" placeholder="Email" style="width: 500px;  height: 40px; border-radius: 0px; background-color: lightgreen;  border: none white; margin-left: 500px;">  

  </div>  
  <div class="form-group">  
    <label style="font-size: 20px; margin-left: 500px;">discription</label>  <br>
   
   <input type="textarea" name="suggections" style="height:100px; width: 500px;  background-color: lightgreen;
...
<br>
  <button type="submit"  style="width: 100px; margin-left: 500px;" >submit</button>  
</form>  
  ...
  <script type="text/javascript">
    function check()
    {
      if(document.fo1.email.value=="")
  {
    alert("Plese Enter your Email Address");
  document.fo1.email.focus();
  return false;
  }
  e=document.form1.email.value;
    ...
    if (document.fo1.suggections.value=="") {
      alert("Plese write something in suggection box");
  document.fo1.suggections.focus();
  return false;
    }
...
"><center>
	...
	<a href="#" style="color: white;">contact : anurag.cs18@nitp.ac.in</a> <a href="#" style="color: white;">&   santosh.cs18@nitp.ac.in</a>
	</center>
	<br>
</footer>
